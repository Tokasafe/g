<div>
    ...
    <!-- The button to open modal -->
    <label for="responsibleRole" class="btn btn-sm btn-square btn-info "><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <input type="checkbox" id="responsibleRole" class="modal-toggle" />
    <div class="modal ">
        <div class="modal-box">
            <h3 class="text-lg font-bold text-center">Add Responsible Role!</h3>
            <form wire:submit.prevent='store'>
                ...
                <div class="modal-action">
                    ...
                    <label for="responsibleRole" class="btn btn-xs btn-error">{{ __('Close') }}!</label>
                </div>
            </form>
        </div>
    </div>
