<div>
    ...
    <div class="modal @if (!empty($openModal)) modal-open @endif">
        <div class="modal-box">
            <h3 class="text-lg font-bold text-center">Update Workflow Step!</h3>
            <form wire:submit.prevent='store'>
                ...
                <div class="w-full max-w-xs form-control">
                    ...
                    <input type="text" placeholder="Type here" wire:model='description'
                        class=" @error('description') border-rose-500 border-2 @enderror w-full max-w-xs input input-bordered input-success input-sm focus:outline-none focus:border-success focus:ring-success focus:ring-1" />
                    <x-input-error :messages="$errors->get('description')" class="mt-0" />
                </div>
                <div class="w-full max-w-xs form-control">

                    <x-input-label-req :value="__('Stauts Code')" />
                    <input type="text" placeholder="Type here" wire:model='status_code'
                        class=" @error('status_code') border-rose-500 border-2 @enderror w-full max-w-xs input input-bordered input-success input-sm focus:outline-none focus:border-success focus:ring-success focus:ring-1" />
