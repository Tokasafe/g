<div>
    ...
    <div class="{{ $modalOpenEvent === 'modal-open' ? 'modal modal-open' : 'modal' }}">
        <div class="w-11/12 max-w-5xl modal-box">
            <div class="divider divider-warning"> <h3 class="text-lg font-bold text-center">Action Editor!</h3></div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="w-full max-w-xs form-control">
                                    ...
                                    <textarea type="text" wire:model='report' placeholder="Type here"
