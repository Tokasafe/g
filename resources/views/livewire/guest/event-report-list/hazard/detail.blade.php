<div>
    ...
    <div class="m-1  p-2 rounded-md sm:w-full ">
        ...
        <div class="flex flex-row pl-2 sm:pl-0">
            ...
            <div class="w-40 text-xs text-gray-500 font-semibold">: {{ date('d-M-Y', strtotime($tanggal_kejadian)) }}</div>
        </div>
        <div class="flex flex-row pl-2 sm:pl-0">
    ...
    <div class="shadow-md p-0 ">
        <form id="commentForm" wire:submit.prevent='store' wire:loading.class="skeleton" wire:target="store">
            ...
            <div class=" {{ $hazardClose ? 'stack' : '' }}">
                ...
                <div
                    ...
                    <div class="flex flex-wrap justify-center gap-2 sm:justify-normal">
                        ...
                        <div class="w-full max-w-xs form-control">
                            @if (!empty($documentation))
                                <label class="btn btn-ghost" wire:click="download('{{ $data_id }}')">
                                    <i
                                        class="
                    ...
                    <div class="flex flex-wrap justify-center gap-2 sm:justify-normal my-4">
                        <div class="w-full border border-accent p-4">
                            ...
                            @livewire('guest.event-report-list.action.index', ['id' => $data_id])
                        </div>
                    </div>
                    <div class="flex flex-wrap justify-center gap-2 sm:justify-normal my-4">
                        <div class="w-full border border-accent p-4">
                            ...
                            @livewire('guest.event-report-list.document.index',  ['id' => $data_id])
                        </div>
                    </div>
                    <div class="flex flex-wrap justify-center gap-2 sm:justify-normal my-4">
                        <div class="w-full max-w-xs sm:max-w-screen-2xl form-control ">
                ...
                <div class=" {{ $hazardClose ? 'w-full  sm:h-40  xl:h-126 flex justify-center z-20' : '' }} ">
                    <p
                        class=" {{ $hazardClose ? 'self-center text-6xl sm:text-9xl font-black font-mono text-rose-500 italic z-20' : 'hidden' }}">
                      CLOSED</p>
                </div>
            </div>
        </form>
