<div>
    ...
    <div class="modal ">
        <div class="modal-box">
            <h3 class="text-lg font-bold text-center">Input Document!</h3>
            <form >
                @csrf
                ...
                <div class="overflow-y-auto h-80">
                    ...
                    <div class="w-full max-w-xs form-control">
                        ...
                        <x-input-label-req :value="__('File Title')" />
                        <input type="text" placeholder="Type here" wire:model='fileTitle'
                            class=" @error('fileTitle') border-rose-500 border-2 @enderror w-full max-w-xs input input-bordered input-success input-xs focus:outline-none focus:border-success focus:ring-success focus:ring-1" />
                ...
                <div class="modal-action">
                    <button wire:click='store_document' class="text-white btn btn-success btn-xs">Save
