<div>
    ...
    <div class="flex justify-between mx-4 mt-4">
        <div>
            ...
            @livewire('event-report.participan.create', ['id' => $ID_Details])
        </div>
        <div class="join">
    ...
    <div class="mx-4 mt-4 overflow-x-auto rounded-md shadow-md">
        ...
        <table class="table table-xs">
            ...
            <tbody>
                @forelse ($PihakTerlibat as $index => $item)
                    <tr class="text-center">
                        <th>{{ $PihakTerlibat->firstItem() + $index }}</th>
                        <td>{{ $item->name }}</td>
                        ...
                        <td>
                            <div class="flex flex-row justify-center gap-1">
                                ...
                                <label wire:click="update_Pihak({{ $item->id }})"
                                    class="btn btn-xs btn-warning ">Edit</label>
                                <label for="delete_data" wire:click="deletePihak({{ $item->id }})"
                ...
                @empty
                    <tr class="text-center">
                        <td class="text-rose-500" colspan="9">Not Found!!</td>
                    </tr>
                @endforelse
            </tbody>
