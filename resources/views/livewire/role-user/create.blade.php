<div>
    ...
    <!-- The button to open modal -->
    <label for="statusCode" class="btn btn-sm btn-square btn-info "><svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5"
    ...
    <input type="checkbox" id="statusCode" class="modal-toggle" />
    <div class="modal ">
        <div class="modal-box">
            <div class="divider divider-success font-semibold">{{ __('add') }} Role Users</div>
            <form wire:submit.prevent='store'>
                ...
                <div class="modal-action">
                    ...
                    <label for="statusCode" class="btn btn-xs btn-error">{{ __('Close') }}!</label>
                </div>
            </form>
        </div>
    </div>
